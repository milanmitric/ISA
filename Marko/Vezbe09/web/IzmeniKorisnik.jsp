...
<body>
		...
		<div id="izmeniKorisnika_window">
			...
			<form class="form-horizontal" id="register_form" role="form" action="./IzmeniKorisnikaController" method="post"  accept-charset="UTF-8">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" name="ime" value ="${korisnik.imeKorisnika}" class="form-control" placeholder="Ime" required/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" name="prezime" value ="${korisnik.prezimeKorisnika}" class="form-control" placeholder="Prezime" required/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text"  id ="korisnicko_ime" value ="${korisnik.korisnickoImeKorisnika}" disabled name="korisnicko_ime" class="form-control" placeholder="Korisnicko ime" required/>
					</div>
				</div>
