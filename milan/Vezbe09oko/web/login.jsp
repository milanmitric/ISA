...
<body>
	<div class="container">
		...
		<form class="form-signin" action="./ManagerLoginController" method="post" class="form-signin" accept-charset="ISO-8859-1">
	        <h1 class="form-signin-heading">Dobrodošli</h1>
	        <h4 class="form-signin-heading">Stranica za logovanje gosta restorana</h4>
